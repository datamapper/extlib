...
[ false, true ].each do |loaded|
  describe LazyArray do
    ...
    describe '#at' do
      ...
      it_should_be_a_kicker(:at, 0) unless loaded
    ...
    describe '#collect!' do
      ...
      it_should_be_a_kicker(:collect!) { |entry| entry } unless loaded
    ...
    describe '#concat' do
      ...
      it_should_be_a_kicker(:concat, []) unless loaded
    ...
    describe '#delete' do
      ...
      it_should_be_a_kicker(:delete, nil) unless loaded
    ...
    describe '#delete_at' do
      ...
      it_should_be_a_kicker(:delete_at, 0) unless loaded
    ...
    describe '#delete_if' do
      ...
      it_should_not_be_a_kicker(:delete_if) { |e| true } unless loaded
    ...
    describe '#dup' do
      ...
      it_should_not_be_a_kicker(:dup) unless loaded
    ...
    describe '#each' do
      ...
      it_should_be_a_kicker(:each) {|e| true } unless loaded
    ...
    describe '#each_index' do
      ...
      it_should_be_a_kicker(:each) {|e, i| true } unless loaded
    ...
    describe '#empty?' do
      ...
      it_should_be_a_kicker(:empty?) unless loaded
    ...
    describe '#entries' do
      ...
      it_should_be_a_kicker(:entries) unless loaded
    ...
    describe '#freeze' do
      it_should_not_be_a_kicker(:freeze) unless loaded
    ...
    describe '#eql?' do
      ...
      it_should_be_a_kicker(:eql?, []) unless loaded
    ...
    describe '#fetch' do
      ...
      it_should_be_a_kicker(:fetch, 0) unless loaded
    ...
    it 'should provide #include' do
      @lazy_array.should respond_to(:include?)
    end
    ...
    describe '#include' do
      describe 'with an included entry' do
        before do
          @lazy_array << @steve
          @return = @lazy_array.include?(@steve)
        end
      ...
      describe 'with an unknown entry' do
        before do
          @return = @lazy_array.include?(@steve)
        end
    ...
    describe '#index' do
      ...
      it_should_be_a_kicker(:index, nil) unless loaded
    ...
    describe '#push' do
      ...
      it_should_not_be_a_kicker(:push, @steve) unless loaded
    ...
    describe '#reject' do
      ...
      it_should_be_a_kicker(:reject) { |entry| false } unless loaded
    ...
    describe '#reverse' do
      ...
      it_should_be_a_kicker(:reverse) unless loaded
    ...
    describe '#reverse_each' do
      ...
      it_should_be_a_kicker(:reverse_each) { |entry| } unless loaded
    ...
    describe '#rindex' do
      ...
      it_should_be_a_kicker(:rindex, nil) unless loaded
    ...
    describe '#select' do
      ...
      it_should_be_a_kicker(:select) { |entry| true } unless loaded
    ...
    describe '#size' do
      ...
      it_should_be_a_kicker(:size) unless loaded
    ...
    describe '#sort' do
      ...
      it_should_be_a_kicker(:sort) unless loaded
    ...
    describe '#to_a' do
      ...
      it_should_be_a_kicker(:to_a) unless loaded
    ...
    describe '#to_ary' do
      ...
      it_should_be_a_kicker(:to_ary) unless loaded
    ...
    describe '#to_proc' do
      ...
      it_should_not_be_a_kicker(:to_proc) unless loaded
    ...
    describe '#unshift' do
      ...
      it_should_not_be_a_kicker(:unshift, @steve) unless loaded
    ...
    describe '#values_at' do
      ...
      it_should_be_a_kicker(:values_at, 0) unless loaded
